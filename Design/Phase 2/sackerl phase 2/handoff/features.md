...
> **Read first.** This file is part of a handoff package. For visual specs,
> tokens, component anatomy, and per-screen layouts, see:
> - [`design-system.md`](./design-system.md) — tokens, type, components, motion, voice
> - [`screens.md`](./screens.md) — per-screen ASCII layouts, copy, states
> - [`epics.md`](./epics.md) — epic overview & delivery order
> - `index.html` — the visual source of truth (open the design canvas)
