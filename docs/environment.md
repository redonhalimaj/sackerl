...
| `OCR_PROVIDER`                  | Receipt parsing provider selector. Defaults to deterministic local parsing; future vendor values such as Mindee or Vision must use server-only secrets. |
